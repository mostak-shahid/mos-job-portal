...
function mos_jportal_options_page() {
	...
	//add_submenu_page( 'options-general.php', 'Settings', 'Settings', 'manage_options', 'mos_jportal_settings', 'mos_jportal_admin_page' );
}
add_action( 'admin_menu', 'mos_jportal_options_page' );
function mos_jportal_options_page_html(){
